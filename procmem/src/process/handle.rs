...
use winapi::{um::{handleapi::{CloseHandle, INVALID_HANDLE_VALUE},
                  ...
                  processthreadsapi::{OpenProcess, GetExitCodeProcess},
...
impl Handle {
    ...
    /// if the wrapper contains a handle that is currently running
    pub fn is_open(&self) -> bool {
        let mut status = 0_u32;

        unsafe {
            GetExitCodeProcess(self.0, (&mut status) as *mut _);
        };
